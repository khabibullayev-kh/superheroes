  ...
  testWidgets('module2', (WidgetTester tester) async {
    await tester.runAsync(() async {
      ...
      expect(
        ...
        isNotNull,
        reason: "progressIndicatorBuilder property in CachedNetworkImage shouldn't be null",
      );
      ...
      expect(
        ...
        findsOneWidget,
        reason: "Expected to find CircularProgressIndicator during image loading",
      );
